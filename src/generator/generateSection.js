...
scene.sectionGenerator=function(){
  ...
  if(scene.current==1||scene.last==1){ scene.type1=0; }
    ...
    if(scene.type1==1&&scene.section1==2){ scene.type1++; }
  ...
  if(scene.current==2||scene.last==2){ scene.type2=0; }
    ...
    if(scene.type2==1&&scene.section1==2){ scene.type2++; }
  ...
  if(scene.type3==1&&scene.section1==2){ scene.type3++; }
  ...
  if(scene.current==4||scene.last==4){ scene.type4=0; }
	  ...
	  if(scene.type4==1&&scene.section1==2){ scene.type4++; }
  ...
  if(scene.current==5||scene.last==5){ scene.type5=0; }
    ...
    if(scene.type5==1&&scene.section1==2){ scene.type5++; }
